...
public class PointAndClickController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetButton("Fire2")) //by default, the left mouse is hooked to "Fire1"
        {
            ...
            RaycastHit hit;
            int myMask = 1 | 1 << 1 | 1 << 2 | 1 << 4 | 1 << 5;
            if (Physics.Raycast(_GameCamera.transform.position, direction, out hit,10000.0f, myMask))
            {
